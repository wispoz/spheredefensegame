...
public final class TowerCubeHeavyMenu
extends TowerMenu {
	// Inner ---------------------------------------------
	...
	// Constructors --------------------------------------
	public TowerCubeHeavyMenu() {
		super();
	}
	
	public TowerCubeHeavyMenu(String name, String parentName, 
	...
	protected void updateButtonPositions() {
		buttons.get("btn_sale_cube_heavy").getRectangle().x = rectangle.x + BUTTON_OFFSET;
		buttons.get("btn_sale_cube_heavy").getRectangle().y = rectangle.y + BUTTON_OFFSET;
	}
