...
public final class TowerCylinderHeavyMenu
extends TowerMenu {
	// Inner ---------------------------------------------
	...
	// Constructors --------------------------------------
	public TowerCylinderHeavyMenu() {
		super();
	}
	
	public TowerCylinderHeavyMenu(String name, String parentName, 
	...
	protected void updateButtonPositions() {
		buttons.get("btn_sale_cylinder_heavy").getRectangle().x = rectangle.x + BUTTON_OFFSET;
		buttons.get("btn_sale_cylinder_heavy").getRectangle().y = rectangle.y + BUTTON_OFFSET;
	}
